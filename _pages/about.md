...
I am a third-year PhD candidate in the Department of Computational Precision Health at UC Berkeley where I am fortunate to be advised by Prof. [Ahmed Alaa](https://vcresearch.berkeley.edu/faculty/ahmed-alaa) and Prof. [Irene Chen](https://irenechen.net/). My research focuses on multi-modal learning and interpretability, with an emphasis on robust estimation and reliable performance in high-stakes domains such as healthcare.
